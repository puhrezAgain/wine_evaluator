...
class WineQueryHandlerTest {
    ...
    fun `query sorts matches by descending score`() {
        ...
        val bad = PriceSignal(UploadId(UUID.randomUUID()), setOf("VINA"), listOf(40), "Viña 40")
    ...
    fun `queryByUploadId doesnt match weak candidates`() {
        ...
        val weak = PriceSignal(UploadId(UUID.randomUUID()), setOf("VINA"), listOf(40), "Viña 40")
    ...
    fun `queryByUploadId ignores signals without prices`() {
        ...
        val invalid = PriceSignal(uploadId, setOf("VINA", "TONDONIA"), emptyList(), "Viña Tondonía")
