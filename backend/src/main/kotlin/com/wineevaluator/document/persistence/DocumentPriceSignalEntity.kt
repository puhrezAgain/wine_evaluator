...
class DocumentPriceSignalEntity(
        @Id @GeneratedValue @UuidGenerator(style = UuidGenerator.Style.TIME) val id: UUID? = null,
        @Column(nullable = false) val uploadId: UUID,
        @ElementCollection
        @CollectionTable(
        ...
        @Lob @Column(nullable = false) val rawRow: String,
)
